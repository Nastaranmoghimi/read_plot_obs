...
def find_purple():
    ...
    #### JSON ######
    json_file = inp_dir + 'purpleair_29apr2020.json'
...
name = 'colorado'
region[name]['xmin']  = -110.045869-2
region[name]['xmax']  = -101.344697+2
region[name]['ymin']  =  36.509493-2
region[name]['ymax']  =  41.393161+2
